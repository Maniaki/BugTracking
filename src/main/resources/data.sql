...
INSERT INTO BUG(id, title, description, creationdate, devid, priority, state) VALUES
  (1, 'Impossible Logout/WEB', 'Depuis les paramêtres le bouton logout ne fonctionne pas', '2020-09-02',1, 'BASSE',
   'TODO'),
  (2, 'Images ne chargent pas/WEB', 'Sur la page de customisation les images restent blanches', '2020-09-13',1, 'HAUTE'
  , 'TODO'),
  (3, 'Exeption non supportée/WEB', 'Sur les formulaires l entrée de nombres aux lieu d un String bloque le chargement'
  ,'2020-10-06',4, 'NORMALE', 'TODO'),
  ...
  , '2020-10-22',5, 'BASSE', 'TODO'),
   (7, '404 Profil/WEB', 'L onglet profil produit des erreurs 404', '2020-11-01',5, 'HAUTE', 'TODO'),
  (8, 'Accès stockage manuel/APP', 'La notification de permissions d accès au stockage ne s affiche pas sur certains appareils'
  , '2020-11-04',5, 'HAUTE', 'TODO');